            ...
            <div class="col-sm">
                ...
                <form action="process_edit_article.php" method="post" enctype="multipart/form-data"">
                    <?php
                        ...
                        $author = $conn->query($sql_tg);
                    ?>
                    <input type="hidden" name="id" value="<?= $article['ma_bviet'] ?>">
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tiêu đề</span>
                        <input type="text" class="form-control" name="txtTitle" value="<?= $article['tieude'] ?>" >
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tên bài hát</span>
                        <input type="text" class="form-control" name="txtName" value="<?= $article['ten_bhat'] ?>" >
                    </div>
                    <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtSummary" value="<?= $article['tomtat'] ?>">
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Nội dung</span>
                        <input type="text" class="form-control" name="txtContent" value="<?= $article['noidung'] ?>" >
                    </div>
                    <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="hidden" name="image_old" value="<?php echo $article['hinhanh'] ?>">
                    </div>
                    <div class="input-group mt-3 mb-3">
