...
<body>
    <header>
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded" id="top">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" class="slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" id = "slide-show">
